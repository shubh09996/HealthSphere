...
const Step5Success = ({ details, onDone }) => (
    <div className="bg-card p-8 rounded-xl shadow-xl text-center flex flex-col items-center">
        ...
        <div className="bg-muted my-8 p-6 rounded-lg border-2 border-dashed border-primary/50 w-full max-w-sm">
            <p className="text-muted-foreground text-sm">Your Token Number</p>
            <p className="text-5xl font-bold text-primary tracking-widest my-2">{details.token}</p>
        ...
        <div className="flex items-center gap-6">
            ...
            <button onClick={onDone} className="font-bold py-2.5 px-6 rounded-lg bg-primary text-primary-foreground hover:opacity-90 transition-opacity">
                Book Another
            </button>
        </div>
    </div>
